              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    <Label 
                      htmlFor="unica" 
                      className={`flex items-start space-x-3 p-4 rounded-lg border transition-all cursor-pointer ${field.value === 'unica' ? 'border-primary bg-card shadow-sm' : 'border-border bg-card hover:bg-accent/30'}`}
                    >
                    ...
                    <Label 
                      htmlFor="bandeira" 
                      className={`flex items-start space-x-3 p-4 rounded-lg border transition-all cursor-pointer ${field.value === 'bandeira' ? 'border-primary bg-card shadow-sm' : 'border-border bg-card hover:bg-accent/30'}`}
                    >
                    ...
                    render={({ field }) => (
                      <div className="relative">
                        <Input 
                          ...
                          className="h-10 pl-4 pr-10 text-sm font-semibold rounded-md border-border bg-card"
                          placeholder="Ex: 3.99"
                        />
                          ...
                          render={({ field }) => (
                            <div className="relative">
                              <Input 
                                ...
                                value={field.value === 0 ? '' : field.value} 
                                onChange={e => field.onChange(parseFloat(e.target.value) || 0)}
                                className="h-10 pr-9 rounded-md border-border bg-card font-medium"
